...
if (window.require) {
  ...
  require.config({
    paths: {
      "highlight": "libs/flow/highlight",
      "jquery": "libs/flow/jquery-1.11.3.min.js" // 1.11.3
      /*"bootstrap": "libs/flow/bootstrap.min"*/
    }/*,
    shim: {
      "bootstrap": ["jquery"]
    }*/
  ...
  document.write('<script src="libs/flow/highlight.js"></script>');
  window.jQuery || document.write('<script src="libs/flow/jquery-1.11.3.min.js"></script>'); // 1.11.3
  /*document.write('<script src="libs/flow/bootstrap.min.js"></script>');*/
}
...
link.type = "text/css";
link.rel = "stylesheet";
link.href = "libs/css/flow/bootstrap.min.css";
head.appendChild(link);*/

var link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "libs/css/flow/highlight.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "libs/css/flow/main.css";
head.appendChild(link);
